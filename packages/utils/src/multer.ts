...
const secret_key = process.env.S3_SECRET_KEY || "oG7/LqM3XFmLs4KagbKcUjmDjTivBGbDpL2Wf3B3UEo";
...
export const fileFilters = (req: any, file: any, cb: any) => {
  const allowedMimeTypes = [
    'image/gif', 'audio/mpeg', 'image/png', 'image/jpg', 'image/jpeg',
    'application/octet-stream', 'video/mp4', 'video/MPEG-4', 'video/mkv', 'video/3gpp'
  ];
