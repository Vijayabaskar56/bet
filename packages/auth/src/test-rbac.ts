...
async function runTests() {
  ...
  if (!superadminCookie) {
    ...
    results.push({ test: "Superadmin Login", passed: false, message: "Login failed - check password" });
    printSummary();
    return;
  }
  console.log("✅ PASSED: Superadmin logged in successfully");
  results.push({ test: "Superadmin Login", passed: true, message: "Login successful" });
  ...
  if (createAdminResult.success) {
    ...
    results.push({ test: "Superadmin creates Admin", passed: true, message: "Admin created successfully" });
  } else {
  ...
  if (createUserResult.success) {
    ...
    results.push({ test: "Superadmin creates User", passed: true, message: "User created successfully" });
  } else {
  ...
  if (!adminCookie) {
    ...
    results.push({ test: "Admin Login", passed: false, message: "Login failed" });
    printSummary();
    return;
  }
  console.log("✅ PASSED: Admin logged in successfully");
  results.push({ test: "Admin Login", passed: true, message: "Login successful" });
  ...
  if (!adminCreatesAdminResult.success) {
    ...
    console.log(`   Error received (expected): ${adminCreatesAdminResult.error}`);
    results.push({
    ...
    results.push({
      test: "Admin cannot create Admin",
      passed: false,
      message: "Admin was able to create another admin - constraint not working!",
    });
  }
  ...
  if (adminCreatesUserResult.success) {
    ...
    results.push({ test: "Admin creates User", passed: true, message: "User created successfully" });
  } else {
  ...
  if (!adminCreatesSuperadminResult.success) {
    ...
    console.log(`   Error received (expected): ${adminCreatesSuperadminResult.error}`);
    results.push({
    ...
    results.push({
      test: "Admin cannot create Superadmin",
      passed: false,
      message: "Admin was able to create a superadmin - constraint not working!",
    });
  }
